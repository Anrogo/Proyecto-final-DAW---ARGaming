                ...
                <div class="card-body">
                    <form id="form_registro" action="#" method="POST">
                        <div class="form-group">
                            ...
                            <select name="id_usuario" id="id_usuario" class="form-control">
                                ...
                                foreach( $usuarios as $usuario ){
                                    ...
                                    $selected = set_value('id_usuario') == $id_usuario ? 'selected' : '';
                        ...
                        <div class="form-group">
                            ...
                            <?php
                            echo form_error('imagen', '<div class="error"><svg class="bi bi-exclamation-diamond-fill mr-1" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" d="M9.05.435c-.58-.58-1.52-.58-2.1 0L.436 6.95c-.58.58-.58 1.519 0 2.098l6.516 6.516c.58.58 1.519.58 2.098 0l6.516-6.516c.58-.58.58-1.519 0-2.098L9.05.435zM8 4a.905.905 0 00-.9.995l.35 3.507a.552.552 0 001.1 0l.35-3.507A.905.905 0 008 4zm.002 6a1 1 0 100 2 1 1 0 000-2z" clip-rule="evenodd"/>
                            </svg>', '</div>'); ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="contenido" id="contenido" class="form-control" cols="30" rows="30"><?php echo set_value('contenido'); ?></textarea>
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="visitas" id="visitas" class="form-control" value="<?php echo set_value('visitas'); ?>" min="0" max="999999">
                            <?php
