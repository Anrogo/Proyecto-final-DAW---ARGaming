<div class="header">
    ...
    <div class="container-fluid mt-4">
        <div class="row h-100 d-flex align-items-center">
            <div class="col-12 col-sm-6 col-md-3 mb-sm-2 text-center hijo">
                <a href="/inicio" class="btn btn-lg btn-outline-primary botones"><svg class="bi bi-house-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-sm-2 text-center hijo">
                <a href="/admin/panel-control" class="btn btn-lg btn-outline-primary botones"><svg class="bi bi-tools" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-12 col-sm-6 col-md-3 mb-sm-2 text-center hijo">
                <a href="/admin/perfil-admin" class="btn btn-lg btn-outline-primary botones"><svg class="bi bi-person-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav mr-auto nav-justified w-100">
                ...
                <li class="nav-item">
                    <a href="/admin/panel-control/comentarios" class="nav-link" >Comentarios</a>
                </li>
            </ul>
        </div>
    </nav>
