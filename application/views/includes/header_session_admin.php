        ...
        <div class="row padre">
            <div class="col gray">
                <div class="row h-100 d-flex align-items-center">
                    ...
                    <div class="col-6 col-sm-3 text-center hijo">
                        <a href="/perfil-admin" class="btn btn-lg btn-outline-primary botones"><svg class="bi bi-person-square" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
