    ...
    <div class="container-fluid mt-4">
        <div class="row h-100 d-flex align-items-center">
            <div class="col-12 col-sm-6 col-md-3 mb-sm-2 text-center hijo">
                <a href="/" class="btn btn-lg btn-outline-primary botones"><svg class="bi bi-house-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
